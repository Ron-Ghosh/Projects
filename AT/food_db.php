        ...
        <div class="container well">
            ...
            <form action="food_db_search.php" method="post">
                <div class="col-xs-4 col-xs-offset-4">
                    ...
                    <button type="submit" class="btn btn-default btn-block" name="btnSearchFood">Submit</button> <br>
                </div> <br> <br>
            </form>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    $sql  = 'Select DESCRIPTION, CALORIES, PROTEIN, FAT, CARB, SERVING from food2';
